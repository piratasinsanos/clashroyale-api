...
describe('Rankings /api/v2/rankings', function () {
  ...
  describe('#/GET /api/v2/rankings', () => {
    ...
    it('/get a ranking by id (v2)', (done) => {
      request.agent(app).get(join(['/api/v2/rankings', rankings[0]._id], '/'))
        .set('Content-Type', 'application/x-www-form-urlencoded')
        .set('Authorization', token)
        .expect(200)
        .end((error: any) => {
